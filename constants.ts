...
export const QUESTIONS_BY_SUBJECT: Record<string, QuizTest[]> = {
    'anayasa': [
        { id: 'anayasa-test-1', name: 'Test 1', timeLimit: 30, questions: generateMockQuestions('anayasa-1', 'Anayasa Sorusu', 20) },
        { id: 'anayasa-test-2', name: 'Test 2', timeLimit: 25, questions: generateMockQuestions('anayasa-2', 'Anayasa Sorusu', 20) },
    ],
    'idare': [
        { id: 'idare-test-1', name: 'Test 1', timeLimit: 35, questions: generateMockQuestions('idare-1', 'İdare Hukuku Sorusu', 20) },
    ],
    'ceza': [
        { id: 'ceza-test-1', name: 'Test 1', timeLimit: 40, questions: generateMockQuestions('ceza-1', 'Ceza Hukuku Sorusu', 20) },
        { id: 'ceza-test-2', name: 'Test 2', timeLimit: 30, questions: generateMockQuestions('ceza-2', 'Ceza Hukuku Sorusu', 20) },
    ],
